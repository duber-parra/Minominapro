...
function exportScheduleToPDF(data) {
    ...
    data.departments.forEach((dept)=>{
        ...
        body.push([
            {
                ...
                colSpan: data.weekDates.length + 1,
                styles: {
                    fontStyle: 'bold',
                    fillColor: [
                        230,
        ...
        const deptEmployees = data.employees.filter((emp)=>data.weekDates.some((date)=>{
                const daySchedule = data.getScheduleForDate(date);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/card.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/button.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$trash$2d$2$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Trash2$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/trash-2.js [app-ssr] (ecmascript) <export default as Trash2>"); // Added Library, X, Notebook, User, ImportIcon, ListCollapse, PlusCircle
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$schedule$2d$pdf$2d$exporter$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/schedule-pdf-exporter.ts [app-ssr] (ecmascript)");
...
function SchedulePage() {
    ...
    const [isSavingTemplate, setIsSavingTemplate] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false); // Loading state for saving template
    const [templateToDeleteId, setTemplateToDeleteId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null); // State for template delete confirmation
    ...
    const [configFormType, setConfigFormType] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null); // For the new config modal structure
    ...
    const [itemToDelete, setItemToDelete] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null); // Added 'template' type
    ...
    const [templateSearch, setTemplateSearch] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const filteredTemplates = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        const filtered = templatesArray.filter((temp)=>temp.locationId === selectedLocationId && temp.type === viewMode // Match current viewMode ('day' or 'week')
        );
    ...
    const availableEmployees = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        if (viewMode === 'day' || isEmployeeSelectionModalOpen) {
            const targetDayKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(shiftRequestContext?.date || targetDate, 'yyyy-MM-dd');
    ...
    const handleSaveDepartment = ()=>{
        ...
        if (!name || !locationId) {
            toast({
                ...
                description: 'El nombre y la sede del departamento son requeridos.',
                variant: 'destructive'
            });
            return;
        }
    ...
    const handleSaveEmployee = ()=>{
        ...
        if (!id || !name) {
            toast({
                title: 'Datos Incompletos',
                description: 'El ID y el nombre del colaborador son requeridos.',
                variant: 'destructive'
            });
            return;
        }
    ...
    const handleSaveSchedule = ()=>{
        toast({
            ...
            description: 'Los cambios en el horario se guardan automáticamente.'
        });
    };
        ...
        try {
            ...
            if (viewMode === 'day') {
                ...
                weekDates.forEach((date)=>{
                    const dateKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(date, 'yyyy-MM-dd');
                    const dayData = scheduleData[dateKey];
                    const dailyTemplateAssignments = {};
                    if (dayData && dayData.assignments) {
                        Object.keys(dayData.assignments).forEach((deptId)=>{
            ...
            const assignmentsCount = Object.values(newTemplate.assignments).reduce((acc, dayOrDept)=>{
                if (newTemplate.type === 'day') {
                    return acc + dayOrDept.length;
                } else {
                    return acc + Object.values(dayOrDept).reduce((dayAcc, dept)=>dayAcc + dept.length, 0);
                }
            }, 0);
            if (assignmentsCount === 0) {
                toast({
                    title: "Template Vacío",
                    description: "No se guardó el template porque no tiene turnos asignados.",
                    variant: "default"
                });
            ...
            toast({
                ...
                description: `Template "${templateName}" guardado.`
            });
        } catch (error) {
    ...
    const handleLoadTemplate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((templateId)=>{
        ...
        setScheduleData((prevScheduleData)=>{
            ...
            const hydrateAndCreateAssignments = (templateAssignments, dateForAssignment)=>{
                const hydrated = {};
                const dateKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(dateForAssignment, 'yyyy-MM-dd');
                Object.keys(templateAssignments).forEach((deptId)=>{
                    ...
                    }).filter((assign)=>assign !== null); // Filter out skipped assignments
                });
                return hydrated;
            };
            if (templateToLoad.type === 'day') {
                const dateKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(targetDate, 'yyyy-MM-dd');
                const hydratedAssignments = hydrateAndCreateAssignments(templateToLoad.assignments, targetDate);
                ...
                weekDates.forEach((date, index)=>{
                    ...
                    const sourceDateKey = templateDateKeys.find((key)=>{
                        try {
                            const sourceDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["parseISO"])(key);
                            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isValid$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isValid"])(sourceDate) && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$getDay$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDay"])(sourceDate) === (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$getDay$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getDay"])(date);
                        } catch  {
                            return false;
                        }
                    });
        ...
        toast({
            ...
            description: `Se aplicaron las asignaciones del template "${templateToLoad.name}".`
        });
    ...
    const handleSaveNotes = ()=>{
        toast({
            ...
            description: 'Tus notas han sido guardadas localmente.'
        });
    };
            ...
            children: [
                ...
                items.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                                ...
                                children: [
                                    ...
                                    type === 'template' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        ...
                                        children: [
                                            ...
                                            item.type,
                                            ", ",
                                            item.createdAt ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(item.createdAt), 'dd/MM/yy') : '?',
                                            ")"
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/src/app/schedule/page.tsx",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "opacity-0 group-hover:opacity-100 transition-opacity flex items-center space-x-0.5",
                                children: [
    ...
    const renderConfigDetailForm = ()=>{
        ...
        switch(configFormType){
            ...
            case 'template':
                ...
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "p-4 text-center text-muted-foreground",
                    children: "Selecciona un template de la lista para cargarlo o eliminarlo."
                }, void 0, false, {
                    fileName: "[project]/src/app/schedule/page.tsx",
                    lineNumber: 2140,
                    columnNumber: 24
                                                                            ...
                                                                            children: [
                                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                    ...
                                                                                    children: [
                                                                                        ...
                                                                                        activeConfigTab !== 'templates' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                                                                            variant: "outline",
                                                                                            size: "icon",
                                                                                            onClick: ()=>openConfigForm(activeConfigTab, null),
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__2a92b111._.js.map