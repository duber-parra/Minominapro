(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_e357b2ad._.js", {
...
function exportPayrollToPDF(summary, employeeId, periodStart, periodEnd, otrosIngresosLista, otrasDeduccionesLista, auxTransporteAplicado// Add transport allowance parameter
    ...
    // --- Save the PDF ---
    const filename = `Nomina_${employeeId}_${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(periodStart, 'yyyyMMdd')}-${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(periodEnd, 'yyyyMMdd')}.pdf`;
    doc.save(filename);
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/date-fns/format.mjs [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$locale$2f$es$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/date-fns/locale/es.mjs [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$results$2d$display$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/results-display.tsx [app-client] (ecmascript)"); // Assuming formatCurrency is exported and correct
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$alert$2d$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/alert-dialog.tsx [app-client] (ecmascript)"); // Import for delete confirmation
'use client';
;
;
;
...
const firebaseConfig = {
    apiKey: ("TURBOPACK compile-time value", "AIzaSyBEdaK17t-QaB-yvUuP6--aZiBj-tNRiHk"),
    authDomain: ("TURBOPACK compile-time value", "calculadora-de-horas-wshe0.firebaseapp.com"),
    projectId: ("TURBOPACK compile-time value", "calculadora-de-horas-wshe0"),
    storageBucket: ("TURBOPACK compile-time value", "calculadora-de-horas-wshe0.firebasestorage.app"),
    messagingSenderId: ("TURBOPACK compile-time value", "128893274714"),
    appId: ("TURBOPACK compile-time value", "1:128893274714:web:b8a084377a9293b534e663"),
    databaseURL: ("TURBOPACK compile-time value", "https://calculadora-de-horas-wshe0-default-rtdb.firebaseio.com/")
};
...
if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getApps"])().length) {
    // Check if API key is provided and not the placeholder or a generic 'YOUR_API_KEY'
    const placeholderApiKey = "AIzaSyBEdaK17t-QaB-yvUuP6--aZiBj-tNRiHk"; // Placeholder for comparison
    if (!firebaseConfig.apiKey || firebaseConfig.apiKey === placeholderApiKey || firebaseConfig.apiKey === "YOUR_API_KEY") {
        const errorMsg = "Firebase API Key is missing or is a placeholder. Please check your .env.local (NEXT_PUBLIC_FIREBASE_API_KEY) and restart the server.";
        console.error(errorMsg, "Raw env value:", ("TURBOPACK compile-time value", "AIzaSyBEdaK17t-QaB-yvUuP6--aZiBj-tNRiHk"));
    // In a real app, you might throw an error or handle this more gracefully
    // For now, we log the error, but let initialization proceed (it will likely fail later)
    }
    if (!firebaseConfig.databaseURL) {
        console.warn("Firebase Database URL (NEXT_PUBLIC_FIREBASE_DATABASE_URL) is not set in .env.local. Database operations will fail.");
    }
    try {
        ...
        if (error.code === 'auth/invalid-api-key' || error.message && error.message.includes('invalid-api-key')) {
            console.error("The Firebase API Key is invalid. Check Firebase Console and .env.local.");
        }
    // Re-throw or handle as needed - for now, app will be undefined
    }
} else {
    app = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$app$2f$dist$2f$esm$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getApp"])(); // Use existing app instance
// console.log("Using existing Firebase app instance."); // Optional: log reuse
}
;
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
...
"[project]/src/hooks/use-data-migration.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/firebase/config.ts [app-client] (ecmascript)"); // Assuming firebase config is exported
var _s = __turbopack_context__.k.signature();
;
;
;
const useDataMigration = (userId)=>{
    _s();
    const [migrationComplete, setMigrationComplete] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [isChecking, setIsChecking] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true); // State to track check status
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useDataMigration.useEffect": ()=>{
            const migrateData = {
                "useDataMigration.useEffect.migrateData": async ()=>{
                    if (!userId) {
                        setIsChecking(false); // No user, no migration needed
                        setMigrationComplete(true); // Treat as complete if no user
                        return;
                    }
                    setIsChecking(true); // Start checking/migration process
                    try {
                        const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDatabase"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["app"]); // Use the initialized app
                        // 1. Check if a migration flag exists in Firebase for this user.
                        //    We use a dedicated flag to avoid re-running on every login if data fetch fails later.
                        const migrationFlagRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ref"])(db, `users/${userId}/migrationStatus/localStorageMigrated`);
                        const migrationSnapshot = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["get"])(migrationFlagRef);
                        if (migrationSnapshot.exists() && migrationSnapshot.val() === true) {
                            console.log('LocalStorage data already migrated to Firebase, skipping.');
                            setMigrationComplete(true);
                            setIsChecking(false);
                            return;
                        }
                        // Migration flag not set or false, proceed with migration attempt
                        // 2. Check if there's actually any relevant data in localStorage to migrate
                        const keysToMigrate = [
                            'schedulePlannerLocations',
                            'schedulePlannerDepartments',
                            'schedulePlannerEmployees',
                            'schedulePlannerData',
                            'schedulePlannerNotes',
                            'scheduleCalendarEvents',
                            'schedulePlannerTemplates'
                        ];
                        const hasDataToMigrate = keysToMigrate.some({
                            "useDataMigration.useEffect.migrateData.hasDataToMigrate": (key)=>localStorage.getItem(key) !== null
                        }["useDataMigration.useEffect.migrateData.hasDataToMigrate"]);
                        if (!hasDataToMigrate) {
                            console.log('No relevant localStorage data found to migrate.');
                            // Set the migration flag in Firebase even if there was nothing to migrate,
                            // so we don't check localStorage again next time.
                            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["set"])(migrationFlagRef, true);
                            setMigrationComplete(true);
                            setIsChecking(false);
                            return;
                        }
                        console.log('Starting data migration from localStorage to Firebase...');
                        // 3. Load data from localStorage safely
                        const locations = JSON.parse(localStorage.getItem('schedulePlannerLocations') || '[]');
                        const departments = JSON.parse(localStorage.getItem('schedulePlannerDepartments') || '[]');
                        const employees = JSON.parse(localStorage.getItem('schedulePlannerEmployees') || '[]');
                        const scheduleData = JSON.parse(localStorage.getItem('schedulePlannerData') || '{}');
                        const scheduleNotes = localStorage.getItem('schedulePlannerNotes') || '';
                        const scheduleEvents = JSON.parse(localStorage.getItem('scheduleCalendarEvents') || '[]');
                        const scheduleTemplates = JSON.parse(localStorage.getItem('schedulePlannerTemplates') || '[]');
                        // Construct the data object to save under the user's main node
                        ...
                        // 4. Upload data to Firebase user's node
                        const userRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ref"])(db, `users/${userId}`);
                        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["set"])(userRef, userDataToSave); // This replaces any existing data at userRef
                        // 5. Set the migration flag in Firebase to prevent re-migration
                        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["set"])(migrationFlagRef, true);
                        // 6. Clear migrated data from localStorage (Optional but Recommended)
                        keysToMigrate.forEach({
                            "useDataMigration.useEffect.migrateData": (key)=>localStorage.removeItem(key)
                        }["useDataMigration.useEffect.migrateData"]);
                        console.log('LocalStorage cleared after successful migration.');
                        console.log('Data migration to Firebase complete.');
                        setMigrationComplete(true);
                    } catch (error) {
                        console.error('Data migration error:', error);
                        // Handle migration error (e.g., show an error message, maybe retry?)
                        // For now, we set complete to true to avoid blocking indefinitely,
                        // but you might want a more robust error handling/retry mechanism.
                        setMigrationComplete(true); // Allow app to proceed even if migration fails
                    } finally{
                        setIsChecking(false); // Finish checking/migration attempt
                    }
                }
            }["useDataMigration.useEffect.migrateData"];
            // Run migration check only once per user session when userId becomes available
            if (userId) {
                migrateData();
            } else {
                // Handle the case where the user logs out while checking/migrating?
                setIsChecking(false);
                setMigrationComplete(true); // No user, migration is effectively "complete"
            }
        }
    }["useDataMigration.useEffect"], [
        userId
    ]); // Depend only on userId
    // Return both migration status and checking status
    return {
        migrationComplete,
        isCheckingMigration: isChecking
    };
};
_s(useDataMigration, "6m1CwDXzVwgfRB726Qz52Fa/XHk=");
const __TURBOPACK__default__export__ = useDataMigration;
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$workday$2d$form$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/workday-form.tsx [app-client] (ecmascript)"); // Import formSchema
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$import$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ImportIcon$3e$__ = __turbopack_context__.i("[project]/node_modules/lucide-react/dist/esm/icons/import.js [app-client] (ecmascript) <export default as ImportIcon>");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$database$2f$dist$2f$esm$2f$index$2e$esm$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/node_modules/firebase/database/dist/esm/index.esm.js [app-client] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@firebase/database/dist/index.esm2017.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/firebase/config.ts [app-client] (ecmascript)"); // Assuming you have a firebase config file
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$data$2d$migration$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/use-data-migration.ts [app-client] (ecmascript)"); // Import the migration hook
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
const SCHEDULE_DATA_KEY = 'schedulePlannerData'; // LocalStorage key for schedule data - KEEP FOR IMPORTING
// Firebase DB Path Generation
const getFirebaseUserPath = (userId)=>userId ? `users/${userId}` : null;
const getFirebasePayrollsPath = (userId)=>userId ? `users/${userId}/payrolls` : null;
const getFirebasePayrollPath = (userId, payrollKey)=>userId ? `users/${userId}/payrolls/${payrollKey}` : null;
// Helper function to generate a unique key for Firebase payroll storage
const generateFirebasePayrollKey = (employeeId, periodStart, periodEnd)=>{
    if (!employeeId || !periodStart || !periodEnd || isNaN(periodStart.getTime()) || isNaN(periodEnd.getTime())) return null;
    try {
        ...
        // Use a format Firebase likes for keys, avoiding invalid characters like '.' or '$'
        return `payroll_${safeEmployeeId}_${startStr}_${endStr}`;
    } catch (e) {
        console.error("Error generando la clave de Firebase:", e);
        return null;
    }
};
// Helper function to parse data fetched from Firebase
const parseFirebasePayrollData = (data)=>{
    if (!data) return {
        days: [],
        income: [],
        deductions: [],
    ...
    try {
        const revivedDays = (data.calculatedDays || []).map((day)=>({
                ...day,
                inputData: {
                    ...day.inputData,
                    // Parse the ISO string back to a Date object
                    startDate: day.inputData.startDate && typeof day.inputData.startDate === 'string' ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseISO"])(day.inputData.startDate) : new Date()
                }
            }));
        const incomeList = Array.isArray(data.otrosIngresosLista) ? data.otrosIngresosLista : [];
        const deductionList = Array.isArray(data.otrasDeduccionesLista) ? data.otrasDeduccionesLista : [];
        const includeTransport = typeof data.incluyeAuxTransporte === 'boolean' ? data.incluyeAuxTransporte : false;
        return {
            days: revivedDays,
            income: incomeList,
...
// Helper function to load all saved payrolls from Firebase
const loadAllSavedPayrollsFromFirebase = async (userId)=>{
    if (!userId) return [];
    const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDatabase"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["app"]);
    const payrollsPath = getFirebasePayrollsPath(userId);
    if (!payrollsPath) return [];
    try {
        const snapshot = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["get"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ref"])(db, payrollsPath));
        if (snapshot.exists()) {
            const payrollsData = snapshot.val();
            const savedPayrolls = Object.keys(payrollsData).map((key)=>{
                const payroll = payrollsData[key];
                const match = key.match(/^payroll_([a-zA-Z0-9_-]+)_(\d{4}-\d{2}-\d{2})_(\d{4}-\d{2}-\d{2})$/);
                if (!match) return null; // Skip invalid keys
                ...
                if (!employeeId || isNaN(startDate.getTime()) || isNaN(endDate.getTime())) {
                    console.warn(`Omitiendo clave de Firebase inválida: ${key}`);
                    return null;
                }
                const { days: parsedDays, income: parsedIncome, deductions: parsedDeductions, includeTransport: parsedIncludeTransport } = parseFirebasePayrollData(payroll);
                // Re-calculate summary if needed, or assume stored summary is okay
                // For robustness, recalculating might be safer
                const summary = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$payroll$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateQuincenalSummary"])(parsedDays, SALARIO_BASE_QUINCENAL_FIJO) || {
                    ...
                    totalDuracionTrabajadaHorasQuincena: 0,
                    diasCalculados: parsedDays.length
                };
                return {
                    key: key,
                    ...
                    // Use a stored createdAt if available, otherwise fallback
                    createdAt: payroll.createdAt ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseISO"])(payroll.createdAt) : startDate
                };
        ...
        console.error("Error cargando nóminas guardadas de Firebase:", error);
        return [];
    }
};
function Home() {
    ...
    const auth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm2017$2f$index$2d$e84cf44d$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__o__as__getAuth$3e$__["getAuth"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["app"]);
    const [currentUser, setCurrentUser] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(auth.currentUser);
    const userId = currentUser?.uid || null;
    const migrationComplete = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$data$2d$migration$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(userId); // Use the migration hook
    ...
    const [isDataLoaded, setIsDataLoaded] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false); // Tracks initial load for the selected period
    const [isLoadingPayrolls, setIsLoadingPayrolls] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true); // Loading state for the saved list
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            const unsubscribe = auth.onAuthStateChanged({
                ...
                // Optionally trigger initial data load for logged-in user here
                }
    ...
    // --- Load ALL saved payrolls from Firebase on mount or user change ---
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            if (userId && migrationComplete) {
                setIsLoadingPayrolls(true);
                loadAllSavedPayrollsFromFirebase(userId).then(setSavedPayrolls).finally({
                    "Home.useEffect": ()=>setIsLoadingPayrolls(false)
                }["Home.useEffect"]);
            } else {
                setSavedPayrolls([]); // Clear list if no user
        ...
        userId,
        migrationComplete
    ]); // Rerun when userId or migration status changes
    // --- Load current employee/period data from Firebase when employee/period/user changes ---
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            if (userId && employeeId && payPeriodStart && payPeriodEnd && migrationComplete) {
                const firebaseKey = generateFirebasePayrollKey(employeeId, payPeriodStart, payPeriodEnd);
                if (firebaseKey) {
                    const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDatabase"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["app"]);
                    const payrollPath = getFirebasePayrollPath(userId, firebaseKey);
                    if (!payrollPath) {
                        setIsDataLoaded(true); // Path generation failed, treat as no data
                        return;
                    }
                    console.log(`Intentando cargar datos de Firebase para la clave: ${firebaseKey}`);
                    setIsDataLoaded(false); // Set loading state for current period data
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["get"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ref"])(db, payrollPath)).then({
                        "Home.useEffect": (snapshot)=>{
                            if (snapshot.exists()) {
                                const data = snapshot.val();
                                const { days, income, deductions, includeTransport } = parseFirebasePayrollData(data);
                                setCalculatedDays(days);
                                setOtrosIngresos(income);
                                setOtrasDeducciones(deductions);
                                setIncluyeAuxTransporte(includeTransport);
                                console.log(`Datos cargados de Firebase para ${firebaseKey}.`);
                                toast({
                                    title: 'Datos Cargados',
                                    description: `Se cargaron turnos y ajustes para ${employeeId} desde la base de datos.`
                                });
                            } else {
                                // No data found in Firebase for this specific key, reset local state
                                console.log(`No se encontraron datos en Firebase para ${firebaseKey}.`);
                                setCalculatedDays([]);
                                setOtrosIngresos([]);
                                setOtrasDeducciones([]);
                                setIncluyeAuxTransporte(false);
                                toast({
                                    ...
                                    description: `No hay datos guardados para ${employeeId} en este período en la base de datos.`,
                                    variant: 'default'
                                });
                            }
                        }
                        ...
                        "Home.useEffect": (error)=>{
                            console.error("Error cargando datos de Firebase para período actual:", error);
                            toast({
                                title: 'Error al Cargar',
                                description: 'No se pudieron cargar los datos del período desde la base de datos.',
                                variant: 'destructive'
                            });
                        ...
                        "Home.useEffect": ()=>{
                            setIsDataLoaded(true); // Mark loading as complete (success or fail)
                    ...
                    // Key generation failed, reset state
                    setCalculatedDays([]);
                    setOtrosIngresos([]);
                    setOtrasDeducciones([]);
                    setIncluyeAuxTransporte(false);
                ...
                setOtrasDeducciones([]);
                setIncluyeAuxTransporte(false);
                setIsDataLoaded(true); // Mark as loaded (with no data)
            }
        // No action if user logged in but required fields (employeeId, dates) are missing
        // or if migration is not complete
        }
    }["Home.useEffect"], [
        userId,
        employeeId,
        ...
        migrationComplete,
        toast
    ]); // Rerun when these change
    // --- Save current employee/period data to Firebase ---
    // Debounced save function
    const saveDataToFirebase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Home.useCallback[saveDataToFirebase]": async (dataToSave, firebasePath)=>{
            if (!userId || !firebasePath) return; // Need user and path
            const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDatabase"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["app"]);
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["set"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ref"])(db, firebasePath), dataToSave);
                console.log(`Datos guardados en Firebase en la ruta: ${firebasePath}`);
                // Optionally reload the saved list after saving
                loadAllSavedPayrollsFromFirebase(userId).then(setSavedPayrolls);
            } catch (error) {
    ...
    }["Home.useCallback[saveDataToFirebase]"], [
        userId,
        toast
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Home.useEffect": ()=>{
            if (userId && isDataLoaded && migrationComplete) {
                const firebaseKey = generateFirebasePayrollKey(employeeId, payPeriodStart, payPeriodEnd);
                if (firebaseKey) {
                    const payrollPath = getFirebasePayrollPath(userId, firebaseKey);
                    if (!payrollPath) return;
                    const hasDataToSave = calculatedDays.length > 0 || otrosIngresos.length > 0 || otrasDeducciones.length > 0 || incluyeAuxTransporte;
                    ...
                    if (hasDataToSave) {
                        ...
                        const dataToSave = {
                            calculatedDays: calculatedDays.map({
                                "Home.useEffect": (day)=>({
                                        ...
                                        inputData: {
                                            ...day.inputData,
                                            startDate: day.inputData.startDate.toISOString()
                                        }
                                    })
                            }["Home.useEffect"]),
                        ...
                        debounceTimeoutRef.current = setTimeout({
                            "Home.useEffect": ()=>{
                                console.log(`Intentando guardar datos (incluye transporte: ${incluyeAuxTransporte}) en Firebase: ${payrollPath}`);
                                saveDataToFirebase(dataToSave, payrollPath);
                            }
                        }["Home.useEffect"], 1500); // Debounce time (e.g., 1.5 seconds)
                    } else {
                        // No data to save, schedule removal if entry exists
                        debounceTimeoutRef.current = setTimeout({
                            "Home.useEffect": async ()=>{
                                const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDatabase"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["app"]);
                                const snapshot = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["get"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ref"])(db, payrollPath));
                                if (snapshot.exists()) {
                                    console.log(`Clave ${firebaseKey} en Firebase eliminada porque no hay datos ni auxilio de transporte activo.`);
                        ...
                        }["Home.useEffect"], 1500); // Same debounce time for removal check
                    }
                }
            }
        ...
        // Dependencies for the save effect
        }
    }["Home.useEffect"], [
        calculatedDays,
        otrosIngresos,
    ...
    // --- Import Schedule Handler (from LocalStorage - Keep as is for now) ---
    const handleImportSchedule = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Home.useCallback[handleImportSchedule]": async ()=>{
            ...
            if (!userId) {
                toast({
                    ...
                    description: 'Debes iniciar sesión para importar horarios.',
                    variant: 'destructive'
                });
                return;
            }
            ...
            try {
                if ("TURBOPACK compile-time truthy", 1) {
                    const savedScheduleRaw = localStorage.getItem(SCHEDULE_DATA_KEY); // Still reads from LS
                    if (!savedScheduleRaw) throw new Error('No se encontraron datos de horario planificado en almacenamiento local.');
                    ...
                    // Directly update the state, the useEffect will handle saving to Firebase
                    setCalculatedDays({
        ...
        setCalculatedDays,
        userId
    ]); // Added userId dependency
    const handleClearPeriodData = async ()=>{
        if (!userId || !employeeId || !payPeriodStart || !payPeriodEnd) return;
        const firebaseKey = generateFirebasePayrollKey(employeeId, payPeriodStart, payPeriodEnd);
        if (firebaseKey) {
            const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDatabase"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["app"]);
            const payrollPath = getFirebasePayrollPath(userId, firebaseKey);
            ...
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["remove"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ref"])(db, payrollPath));
                console.log(`Datos del período eliminados de Firebase para ${firebaseKey}.`);
                setCalculatedDays([]);
                setOtrosIngresos([]);
                setOtrasDeducciones([]);
                setIncluyeAuxTransporte(false);
                ...
                setEditingResultsId(null);
                setEditedHours(null);
                // Reload the list of saved payrolls after deleting
                loadAllSavedPayrollsFromFirebase(userId).then(setSavedPayrolls);
                toast({
                    title: 'Datos del Período Eliminados',
                    description: `Se han borrado los datos guardados para ${employeeId} en este período de la base de datos.`,
                    variant: 'destructive'
                });
            } catch (error) {
                console.error("Error eliminando datos del período en Firebase:", error);
                toast({
                    title: 'Error al Eliminar',
                    description: 'No se pudieron eliminar los datos del período de la base de datos.',
                    variant: 'destructive'
                });
            }
        }
    ...
    const handleDayCalculationComplete = (data)=>{
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$types$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isCalculationError"])(data)) {
            ...
            setErrorDay(null);
            // Update the state directly; the debounced useEffect will handle saving to Firebase
            ...
            if (!isEditing) {
                ...
                toast({
                    ...
                    description: `Turno para ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(data.inputData.startDate, 'PPP', {
                        locale: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$locale$2f$es$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["es"]
                    })} actualizado. Los cambios se guardarán automáticamente.`
                });
            }
        }
    };
    ...
    const handleSaveResults = ()=>{
        ...
        toast({
            ...
            description: `Las horas para el turno han sido modificadas manualmente. Los cambios se guardarán automáticamente.`
        });
        setEditingResultsId(null);
        setEditedHours(null);
    };
    ...
    const handleDeleteDay = ()=>{
        ...
        toast({
            title: 'Día Eliminado',
            description: 'El cálculo del día ha sido eliminado. Los cambios se guardarán automáticamente.',
            variant: 'destructive'
        });
    ...
    const handleAddIngreso = (data)=>{
        ...
        toast({
            ...
            description: `${data.descripcion || 'Ingreso'}: ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$results$2d$display$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatCurrency"])(data.monto)}. Los cambios se guardarán automáticamente.`
        });
    };
    const handleAddDeduccion = (data)=>{
        ...
        toast({
            ...
            description: `${data.descripcion || 'Deducción'}: ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$results$2d$display$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatCurrency"])(data.monto)}. Los cambios se guardarán automáticamente.`,
            variant: 'default'
        });
    };
    const handleDeleteIngreso = (id)=>{
        ...
        toast({
            title: 'Ingreso Eliminado. Los cambios se guardarán automáticamente.',
            variant: 'destructive'
        });
    };
    const handleDeleteDeduccion = (id)=>{
        ...
        toast({
            title: 'Deducción Eliminada. Los cambios se guardarán automáticamente.',
            variant: 'destructive'
        });
    };
    ...
    const handleDuplicateToNextDay = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Home.useCallback[handleDuplicateToNextDay]": async ()=>{
            ...
            if (!userId) {
                toast({
                    title: 'Usuario no autenticado',
                    description: 'Debes iniciar sesión para duplicar turnos.',
                    variant: 'destructive'
                });
                return;
            }
            ...
            try {
                ...
                handleDayCalculationComplete(result); // This will update state and trigger save
    ...
    const isFormDisabled = !employeeId || !payPeriodStart || !payPeriodEnd || !userId || !migrationComplete; // Disable if no user or migration incomplete
    ...
    const handleExportPDF = ()=>{
        ...
        try {
            const auxTransporteAplicado = incluyeAuxTransporte ? AUXILIO_TRANSPORTE_VALOR : 0;
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$pdf$2d$exporter$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["exportPayrollToPDF"])(currentSummary, employeeId, payPeriodStart, payPeriodEnd, otrosIngresos, otrasDeducciones, auxTransporteAplicado);
            toast({
                title: 'PDF Exportado',
    ...
    const handleBulkExportPDF = async ()=>{
        ...
        // Reload from Firebase before exporting to ensure latest data
        setIsLoadingPayrolls(true);
        try {
            const allPayrollDataToExport = await loadAllSavedPayrollsFromFirebase(userId);
            if (allPayrollDataToExport.length === 0) {
                toast({
                    title: 'No Hay Datos para Exportar',
                    description: 'No se encontraron nóminas guardadas en la base de datos.',
                    variant: 'default'
                });
                return;
            }
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$pdf$2d$exporter$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["exportAllPayrollsToPDF"])(allPayrollDataToExport);
            toast({
    ...
    const handleLoadSavedPayroll = (payrollKey)=>{
        ...
        if (!payrollToLoad || !userId) return;
        setEmployeeId(payrollToLoad.employeeId);
        setPayPeriodStart(payrollToLoad.periodStart);
        setPayPeriodEnd(payrollToLoad.periodEnd);
        // The useEffect for employeeId/period change will handle loading data from Firebase
        setIsDataLoaded(false); // Trigger the data loading useEffect
        toast({
            title: 'Nómina Cargada',
            description: `Cargando datos de ${payrollToLoad.employeeId} para ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(payrollToLoad.periodStart, 'dd/MM/yy')} - ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(payrollToLoad.periodEnd, 'dd/MM/yy')}.`
        });
    };
    const handleDeleteSavedPayroll = async ()=>{
        if (!payrollToDeleteKey || !userId) return;
        const payrollPath = getFirebasePayrollPath(userId, payrollToDeleteKey);
        if (!payrollPath) return;
        try {
            const payrollInfo = savedPayrolls.find((p)=>p.key === payrollToDeleteKey);
            const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDatabase"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$firebase$2f$config$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["app"]);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["remove"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$database$2f$dist$2f$index$2e$esm2017$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ref"])(db, payrollPath)); // Remove from Firebase
            console.log(`Nómina eliminada de Firebase: ${payrollToDeleteKey}`);
            // Update local state immediately
            setSavedPayrolls((prevPayrolls)=>prevPayrolls.filter((p)=>p.key !== payrollToDeleteKey));
            setPayrollToDeleteKey(null); // Close confirmation dialog
            toast({
                title: 'Nómina Guardada Eliminada',
                description: payrollInfo ? `La nómina de ${payrollInfo.employeeId} (${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(payrollInfo.periodStart, 'dd/MM/yy')}) fue eliminada.` : 'Nómina eliminada.',
                variant: 'destructive'
            });
            // If the deleted payroll was the one currently loaded, clear the form/details
            const currentKey = generateFirebasePayrollKey(employeeId, payPeriodStart, payPeriodEnd);
            ...
            console.error("Error deleting saved payroll from Firebase:", error);
            toast({
                title: 'Error al Eliminar',
                description: 'No se pudo eliminar la nómina guardada de la base de datos.',
                variant: 'destructive'
            });
            setPayrollToDeleteKey(null); // Close dialog on error too
        }
    };
    // --- UI Render ---
    if (!migrationComplete && userId) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    children: "Migrando datos a la base de datos..."
                }, void 0, false, {
                    fileName: "[project]/src/app/page.tsx",
                    lineNumber: 899,
                    columnNumber: 17
    ...
    if (!currentUser) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                ...
                children: "Por favor, inicia sesión para usar la calculadora de nómina."
            }, void 0, false, {
                fileName: "[project]/src/app/page.tsx",
                lineNumber: 907,
                columnNumber: 18
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                        ...
                                        children: [
                                            isImporting ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
                                                ...
                                                lineNumber: 986,
                                                columnNumber: 40
                                            }, this) : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$import$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__ImportIcon$3e$__["ImportIcon"], {
                                                className: "mr-2 h-4 w-4"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/page.tsx",
                                                lineNumber: 986,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                        ...
                                        ,
                                        disabled: savedPayrolls.length === 0 || isLoadingPayrolls,
                                        children: [
                                            isLoadingPayrolls ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$loader$2d$circle$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Loader2$3e$__["Loader2"], {
                                                className: "mr-2 h-4 w-4 animate-spin"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/page.tsx",
                                                lineNumber: 1008,
                                            ...
                                            isLoadingPayrolls ? 'Cargando...' : 'Exportar Todo (PDF)'
                                        ]
                                    }, void 0, true, {
                                        fileName: "[project]/src/app/page.tsx",
                                        lineNumber: 1002,
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                            children: [
                                                " ",
                                                isFormDisabled ? 'Ingresa sesión, ID y período.' : editingDayId ? `Modifica fecha/horas.` : 'Ingresa detalles del turno.',
                                                " "
                                            ]
                                        }, void 0, true, {
                                            fileName: "[project]/src/app/page.tsx",
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                    children: [
                                        isFormDisabled ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                " ",
                                                !userId ? 'Inicia sesión primero.' : !migrationComplete ? 'Migrando datos...' : 'Selección pendiente.',
                                                " "
                                            ]
                                        }, void 0, true, {
                                            fileName: "[project]/src/app/page.tsx",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                                children: [
                                                    " ",
                                                    !userId ? 'Inicia sesión primero.' : !migrationComplete ? 'Migrando datos...' : 'Ingresa ID y período para empezar.',
                                                    " "
                                                ]
                                            }, void 0, true, {
                                                fileName: "[project]/src/app/page.tsx",
...
_s(Home, "sG2YVIXvlkRXs6pNCype+X0fwiQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$data$2d$migration$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hook$2d$form$2f$dist$2f$index$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useForm"]
    ];
});
...
//# sourceMappingURL=src_e357b2ad._.js.map