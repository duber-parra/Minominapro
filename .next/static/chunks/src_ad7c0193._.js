(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_ad7c0193._.js", {
...
function exportPayrollToPDF(summary, employeeId, periodStart, periodEnd) {
    ...
    currentY += 6;
    doc.text(`Período: ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(periodStart, 'dd/MM/yyyy', {
        locale: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$locale$2f$es$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["es"]
    })} - ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(periodEnd, 'dd/MM/yyyy', {
        locale: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$locale$2f$es$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["es"]
    })}`, 14, currentY);
    currentY += 10;
    // --- Summary Table ---
    ...
    body.push([
        ...
        {
            content: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$results$2d$display$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatHours"])(summary.totalDuracionTrabajadaHorasQuincena),
            styles: {
                halign: 'right',
                fontStyle: 'bold'
            }
        ...
        '',
        {
            content: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$results$2d$display$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatCurrency"])(summary.totalPagoRecargosExtrasQuincena),
            styles: {
                halign: 'right',
                fontStyle: 'bold',
                textColor: [
        ...
        '',
        {
            content: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$results$2d$display$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatCurrency"])(summary.salarioBaseQuincenal),
            styles: {
                halign: 'right',
                fontStyle: 'normal',
                textColor: [
        ...
        '',
        {
            content: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$results$2d$display$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatCurrency"])(summary.pagoTotalConSalarioQuincena),
            styles: {
                halign: 'right',
                fontStyle: 'bold',
                fontSize: 11,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$pdf$2d$exporter$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/pdf-exporter.ts [app-client] (ecmascript)"); // Import the PDF export function
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
const parseStoredData = (jsonData)=>{
    ...
    try {
        ...
        return data.map((day)=>({
                ...
                inputData: {
                    ...day.inputData,
                    startDate: day.inputData.startDate ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parseISO$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseISO"])(day.inputData.startDate) : new Date()
                }
            }));
    } catch (error) {
...
function Home() {
    ...
    const [isDataLoaded, setIsDataLoaded] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false); // Track initial load
    const { toast } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"])();
            ...
            if ("TURBOPACK compile-time truthy", 1) {
                ...
                if (storageKey) {
                    ...
                    toast({
                        ...
                        variant: storedData ? 'default' : 'default'
                    });
                } else {
    ...
    const handleLoadData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Home.useCallback[handleLoadData]": ()=>{
            ...
            setPayPeriodStart({
                "Home.useCallback[handleLoadData]": (d)=>d ? new Date(d) : undefined
            }["Home.useCallback[handleLoadData]"]);
            setPayPeriodEnd({
                "Home.useCallback[handleLoadData]": (d)=>d ? new Date(d) : undefined
            }["Home.useCallback[handleLoadData]"]);
    ...
    const quincenalSummary = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Home.useMemo[quincenalSummary]": ()=>{
            ...
            return calculatedDays.reduce({
                "Home.useMemo[quincenalSummary]": (summary, currentDay)=>{
                    // Use Object.keys on the summary's structure to ensure all categories are processed
                    Object.keys(summary.totalHorasDetalladas).forEach({
                        "Home.useMemo[quincenalSummary]": (key)=>{
                            const category = key;
            ...
            }["Home.useMemo[quincenalSummary]"], initialSummary);
        }
    }["Home.useMemo[quincenalSummary]"], [
        calculatedDays
    ]);
...
_s(Home, "jIpM5a91jBjC08NyoCqCkP+pjls=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
});
...
//# sourceMappingURL=src_ad7c0193._.js.map