(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_e820f402._.js", {
...
const csvRowSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
    ...
    Fecha: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].string().regex(/^\d{4}-\d{2}-\d{2}$/, "Formato de Fecha debe ser AAAA-MM-DD").optional(),
...
function SchedulePage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SchedulePage.useEffect": ()=>{
            ...
            const loadedTemps = loadFromLocalStorage(SCHEDULE_TEMPLATES_KEY, []);
            ...
            switch(itemToDelete.type){
                ...
                case 'department':
                    ...
                    const updatedTemplatesDept = currentTemplatesDept.map((t)=>{
                        ...
                        if (t.type === 'daily') {
                            if (newAssignments[itemToDelete.id]) {
    ...
    const handleSaveTemplate = ()=>{
        ...
        if (templateType === 'daily') {
            ...
            Object.keys(currentAssignmentsRaw).forEach((deptId)=>{
                if (currentAssignmentsRaw[deptId]?.length > 0) {
                    ...
                    cleanedAssignments[deptId] = currentAssignmentsRaw[deptId].map(({ id, employee, ...rest })=>({
                            ...
                            employee: {
                                id: employee.id
                            } // Only store employee ID reference
                        }));
            ...
            weekDates.forEach((date)=>{
                ...
                if (dayHasData) {
                    templateAssignments[dateKey] = cleanedDailyAssignments;
                }
            });
        }
        ...
        if (!hasDataToSave) {
            toast({
                title: 'Template Vacío',
                description: 'No se encontraron turnos válidos para guardar.',
                variant: 'default'
            });
            ...
            if (templateToLoad.type === 'daily') {
                ...
                if (assignmentsLoadedCount === 0) {
                    ...
                    toast({
                        ...
                        description: `No se encontraron turnos válidos para cargar del template "${templateToLoad.name}".`,
                        variant: 'default'
                    });
                ...
                weekDates.forEach((date)=>{
                    ...
                    updatedScheduleData[dateKey] = {
                        date: date,
                        assignments: {}
                    }; // Reset assignments for each day
                });
                ...
                Object.keys(templateToLoad.assignments).forEach((sourceDateKey)=>{
                    const templateDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parse$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["parse"])(sourceDateKey, 'yyyy-MM-dd', new Date()); // Get Date object from template key
                    ...
                    const dayOfWeek = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$getDay$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDay"])(templateDate); // 0=Sun, 1=Mon,...
                    ...
                    if (targetDateIndex >= 0 && targetDateIndex < weekDates.length) {
                        ...
                        const targetDateKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(targetWeekDate, 'yyyy-MM-dd'); // The key for the scheduleData state
    ...
    const parseScheduleCSV = (content)=>{
        ...
        const missingHeaders = requiredHeaders.filter((reqHeader)=>!headers.some((h)=>h.toLowerCase() === reqHeader.toLowerCase()));
        ...
        const headerMapping = {};
        const schemaKeys = Object.keys(csvRowSchema.shape);
        ...
        for(let i = 1; i < rows.length; i++){
            ...
            headers.forEach((header, index)=>{
                ...
                const standardKey = Object.keys(headerMapping).find((stdKey)=>headerMapping[stdKey]?.toLowerCase() === header.toLowerCase());
                if (standardKey) {
            ...
            if (!rowObject['Fecha']) {
                const firstMondayOfYear = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$startOfWeek$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["startOfWeek"])(new Date(new Date().getFullYear(), 0, 1), {
                    weekStartsOn: 1
                });
                rowObject['Fecha'] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(firstMondayOfYear, 'yyyy-MM-dd');
    ...
    const processCSVAsTemplate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SchedulePage.useCallback[processCSVAsTemplate]": (parsedData)=>{
            ...
            const newScheduleAssignmentsForWeek = {};
            weekDates.forEach({
                "SchedulePage.useCallback[processCSVAsTemplate]": (date)=>{
                    newScheduleAssignmentsForWeek[(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(date, 'yyyy-MM-dd')] = {
                        date,
                        assignments: {}
                    };
                }
            }["SchedulePage.useCallback[processCSVAsTemplate]"]);
            parsedData.forEach({
                "SchedulePage.useCallback[processCSVAsTemplate]": (row)=>{
                    // --- Find Employee ---
                    const employee = employees.find({
                        "SchedulePage.useCallback[processCSVAsTemplate].employee": (emp)=>emp.id === row.ID_Empleado
                    }["SchedulePage.useCallback[processCSVAsTemplate].employee"]);
                    if (!employee) {
                    ...
                    const department = filteredDepartments.find({
                        "SchedulePage.useCallback[processCSVAsTemplate].department": (dep)=>dep.name.toLowerCase() === row.Departamento.toLowerCase()
                    }["SchedulePage.useCallback[processCSVAsTemplate].department"]);
                    if (!department) {
                    ...
                    const csvDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$parse$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["parse"])(row.Fecha || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(new Date(), 'yyyy-MM-dd'), 'yyyy-MM-dd', new Date()); // Use today if Fecha somehow missing after parsing
                    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$isValid$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isValid"])(csvDate)) {
                        console.warn(`[CSV Import] Fecha inválida en CSV "${row.Fecha}", saltando turno.`);
                        errorCount++;
                        return;
                    }
                    let csvDayIndex = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$getDay$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDay"])(csvDate); // 0=Sun, 1=Mon,...
                    ...
                    const targetDateKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$format$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["format"])(targetDateForShift, 'yyyy-MM-dd');
                    ...
                    if (existingAssignmentsForTargetDay.some({
                        "SchedulePage.useCallback[processCSVAsTemplate]": (a)=>a.employee.id === employee.id
                    }["SchedulePage.useCallback[processCSVAsTemplate]"])) {
            ...
            setScheduleData({
                "SchedulePage.useCallback[processCSVAsTemplate]": (prevData)=>({
                        ...prevData,
    ...
    const handleCSVFileChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        ...
        processCSVAsTemplate,
        toast
    ]); // Dependencies include the processing function
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "flex flex-col md:flex-row items-center justify-center gap-4 mb-6 md:mb-8 flex-wrap",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                                                        ...
                                                                                                        children: [
                                                                                                            ...
                                                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$alert$2d$dialog$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AlertDialogDescription"], {
                                                                                                                children: [
                                                                                                                    'Eliminar Sede "',
                                                                                                                    itemToDelete?.name,
                                                                                                                    '"? Se eliminarán sus departamentos, los colaboradores asociados se desvincularán (si no tienen más sedes), y se borrarán templates y turnos relacionados. Esta acción no se puede deshacer.'
                                                                                                                ]
                                                                                                            }, void 0, true, {
                                                                                                                fileName: "[project]/src/app/schedule/page.tsx",
                                                                                                                lineNumber: 2094,
                        ...
                        children: viewMode === 'day' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$popover$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Popover"], {
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$popover$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PopoverTrigger"], {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                        variant: 'outline',
                                        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('w-[200px] sm:w-[280px] justify-start text-left font-normal', !targetDate && 'text-muted-foreground', isHoliday(targetDate) && 'border-primary border-2' // Use primary border
                                        ),
...
_s(SchedulePage, "fuRWvcr7L79GvsD3dM31axqrhzE=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$mobile$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useIsMobile"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
...
//# sourceMappingURL=src_e820f402._.js.map